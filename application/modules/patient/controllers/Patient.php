...
class Patient extends MX_Controller
{
    ...
    function medicalHistory()
    {
        ...
        $data['settings'] = $this->settings_model->getSettingsForPatient();
...
<input type="hidden" name="redirect" value="popuphome">
        ...
        <section class="col-md-3">
            ...
            <aside class="profile-nav">
                <section class="">
                    ...
                    <ul class="nav nav-pills nav-stacked" dir="ltr">
    ...
    public function getSystemPatients()
    {
        // Search term
        $searchTerm = $this->input->post('searchTerm');

        // Get users
        $response = $this->patient_model->getSystemPatients($searchTerm);
