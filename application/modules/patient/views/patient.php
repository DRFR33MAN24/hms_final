    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> <?php echo lang('add_existing'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" action="patient/addExisting" class="clearfix" method="post" enctype="multipart/form-data">


                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('patient'); ?></label>
                        <select class="form-control m-bot15" id="patientchoose3" name="patient" value=''>
...
<script type="text/javascript">
    ...
    var select_patient1 = "<?php echo lang('select_patient'); ?>";
</script>
<script type="text/javascript">
